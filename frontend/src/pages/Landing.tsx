    ...
    >
          ...
          >
            <div className="py-4 border-t border-gray-200 space-y-1">
              ...
              <div className="pt-4 space-y-2">
                ...
                <Button onClick={() => navigate('/signup')} className="w-full bg-indigo-600">
                  Start free trial
                </Button>
              </div>
            </div>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              >
                PipelineIQ analyzes your sales pipeline in real-time, identifies risky deals, 
                and suggests the next action so your team closes more deals faster.
              </motion.p>
                  ...
                  {[1, 2, 3, 4, 5].map((i) => (
                    ...
                    >
                      <Avatar className="w-10 h-10 border-2 border-white ring-2 ring-white shadow-lg">
                        ...
                        <AvatarFallback className="bg-indigo-100 text-indigo-600">U{i}</AvatarFallback>
                      </Avatar>
                    </motion.div>
                  ))}
                  <motion.div 
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    {[
                      { label: 'Total Deals', value: '156', change: '+12%', icon: Briefcase, color: 'indigo' },
                      { label: 'Win Rate', value: '68%', change: '+5%', icon: Target, color: 'green' },
                      { label: 'Revenue', value: '$2.4M', change: '+18%', icon: TrendingUp, color: 'blue' }
                    ].map((stat, i) => {
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between text-sm">
                      <span className="font-medium text-gray-700">Pipeline stages</span>
                      <span className="text-indigo-600">View all</span>
                    </div>
                    
                    {[
                      { stage: 'Qualification', count: 42, value: '$840K', progress: 80, color: 'blue' },
                      { stage: 'Meeting', count: 38, value: '$760K', progress: 65, color: 'indigo' },
                      { stage: 'Proposal', count: 24, value: '$480K', progress: 45, color: 'purple' },
                      { stage: 'Negotiation', count: 12, value: '$320K', progress: 25, color: 'pink' }
                    ].map((item, i) => (
                      <motion.div 
                        key={i}
                        className="space-y-2"
                      ...
                      >
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-medium text-gray-900">{item.count} deals</span>
                        </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">
                          3 deals in "Negotiation" stage haven't been updated in 5+ days. 
                          <span className="text-indigo-600 ml-1 cursor-pointer">Take action →</span>
                        </p>
                      </div>
                    </div>
                  </motion.div>
      ...
      <section className="py-12 border-y border-gray-200 bg-gray-50/50 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <p className="text-center text-sm text-gray-500 mb-8">Trusted by innovative sales teams</p>
      ...
      <section id="problem" className="py-24 px-4">
        <div className="container mx-auto max-w-7xl">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <Badge variant="outline" className="mb-4 px-4 py-1.5 rounded-full">The problem</Badge>
      ...
      <section id="how-it-works" className="py-24 px-4 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        <div className="container mx-auto max-w-7xl relative z-10">
          <motion.div 
            className="text-center mb-16"
            initial={{ opacity: 0, y: 30 }}
            ...
            transition={{ duration: 0.6 }}
          >
            <Badge variant="outline" className="mb-4 px-4 py-1.5 rounded-full">How PipelineIQ works</Badge>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 tracking-tight">
              From pipeline to{' '}
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            ...
            {[
              { step: 1, title: "Connect", desc: "Sync your CRM or import leads", icon: Database, color: "indigo" },
              { step: 2, title: "Analyze", desc: "AI analyzes deal signals and patterns", icon: Brain, color: "purple" },
              { step: 3, title: "Identify", desc: "Get real-time risk alerts", icon: Target, color: "pink" },
              { step: 4, title: "Act", desc: "Take action and close more deals", icon: Rocket, color: "orange" }
            ].map((item, i) => {
              const Icon = item.icon;
              return (
                <motion.div 
          ...
          >
            <div>
              <h3 className="text-3xl font-bold text-gray-900 mb-4">Real-time pipeline intelligence</h3>
              <p className="text-gray-600 mb-6">
                Our AI continuously analyzes your deals, identifying patterns and risks that human eyes might miss.
              </p>
              ...
              >
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-gray-50 rounded-lg">
                    <p className="text-sm text-gray-700">⚠️ 3 deals in negotiation stage are at risk of closing this week</p>
                  </div>
                  <div className="p-3 bg-indigo-50 rounded-lg">
                    <p className="text-sm text-gray-700">💡 Follow up with Acme Corp - they viewed pricing page 5 times</p>
                  </div>
                </div>
              </motion.div>
            </div>
      ...
      <section id="features" className="py-24 px-4">
        <div className="container mx-auto max-w-7xl">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <Badge variant="outline" className="mb-4 px-4 py-1.5 rounded-full">Features</Badge>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 tracking-tight">
      ...
      {/* Testimonials */}
      <section id="testimonials" className="py-24 px-4 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        <div className="container mx-auto max-w-7xl">
          <motion.div 
            className="text-center mb-16"
            initial={{ opacity: 0, y: 30 }}
            ...
            transition={{ duration: 0.6 }}
          >
            <Badge variant="outline" className="mb-4 px-4 py-1.5 rounded-full">Testimonials</Badge>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 tracking-tight">
            ...
            {[
              {
                ...
                content: "45% increase in conversion rates within the first month. The AI insights are game-changing.",
                rating: 5,
              ...
              },
              {
                ...
                content: "The AI insights helped us identify opportunities we were missing. It's like having a superpower.",
                rating: 5,
              ...
              },
              {
                ...
                content: "Saves me hours every week. The email generator alone is worth the subscription.",
                rating: 5,
              ...
              },
              {
                ...
                content: "Finally a CRM that actually helps us sell instead of just tracking. The AI insights are incredible.",
                rating: 5,
              ...
              },
              {
                ...
                content: "Implementation was smooth and the team loves it. Best decision we made this year.",
                rating: 5,
              ...
              },
              {
                ...
                content: "Our forecast accuracy improved dramatically. We actually trust our numbers now.",
                rating: 5,
          ...
          <motion.div 
            ...
            transition={{ duration: 0.6, delay: 0.4 }}
          >
            <p className="text-sm text-gray-500 mb-8">Trusted by 2,000+ companies</p>
      ...
      <section id="pricing" className="py-24 px-4">
        <div className="container mx-auto max-w-7xl">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <Badge variant="outline" className="mb-4 px-4 py-1.5 rounded-full">Pricing</Badge>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 tracking-tight">
              Simple, transparent{' '}
                  ...
                  >
                    ...
                    <CardContent className="p-8">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className={`p-3 rounded-xl bg-${plan.popular ? 'indigo' : 'gray'}-100`}>
                          <Icon className={`w-6 h-6 text-${plan.popular ? 'indigo' : 'gray'}-600`} />
                        </div>
                      </div>
                      <div className="mb-4">
      ...
      <section id="faq" className="py-24 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <Badge variant="outline" className="mb-4 px-4 py-1.5 rounded-full">FAQ</Badge>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 tracking-tight">
              Frequently asked{' '}
          ...
          <div className="grid md:grid-cols-5 gap-8">
            ...
            <div className="col-span-2">
              ...
              <p className="text-sm text-gray-600 mb-4 max-w-xs">
                AI-powered deal intelligence for modern sales teams. Close more deals, faster.
              </p>
            ...
            {[
              ...
              {
                title: "Resources",
                links: ["Documentation", "Blog", "Guides", "Webinars", "Case Studies"]
              },
              {
                title: "Company",
