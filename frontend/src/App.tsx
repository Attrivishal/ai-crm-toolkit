...
import { WorkspaceGuard } from './components/workspace/WorkspaceGuard'; // ← ADD THIS
import { WorkspaceProvider } from './contexts/workspace/WorkspaceContext'; // ← ADD THIS
...
import { CreateWorkspace } from './pages/CreateWorkspace'; // ← ADD THIS
    ...
    <>
      ...
      <WorkspaceProvider> {/* ← ADD THIS */}
        <Routes>
          ...
          {/* Workspace Creation - Protected but no workspace needed yet */}
          <Route element={<ProtectedRoute />}>
            <Route path="/workspaces/create" element={<CreateWorkspace />} /> {/* ← ADD THIS */}
          </Route>

          {/* Protected Dashboard Routes - Require Workspace */}
          <Route element={<ProtectedRoute />}>
            <Route element={<WorkspaceGuard />}> {/* ← ADD THIS */}
